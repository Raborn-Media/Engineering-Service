 ...
 */
load_theme_textdomain('fwp', get_template_directory().'/languages');
...
if (function_exists('acf_add_options_page')) {
    acf_add_options_page([
        'page_title' => __('Theme General Settings', 'fxy'),
        'menu_title' => __('Theme Settings', 'fxy'),
...
register_nav_menus([
    'header-menu' => __('Header Menu', 'fxy'),
    'footer-menu' => __('Footer Menu', 'fxy'),
]);
...
add_action(
    ...
    function () {
        ...
        register_sidebar([
            ...
            'name' => __('Sidebar Right', 'fxy'),
            'description' => __('This sidebar is located on the right-hand side of each page.', 'fxy'),
...
if (!is_admin()) {
    ...
    add_action('admin_head', $fxy_stick_admin_bar);
    add_action('wp_head', $fxy_stick_admin_bar);
}
 ...
 * @return string
 */
$fxy_iframe_wrapper = function ($content) {
    // match any iframes
...
add_filter('the_content', $fxy_iframe_wrapper);
add_filter('acf_the_content', $fxy_iframe_wrapper);
...
add_filter(
    'wbcr/factory/populate_option_backup_origin_images',
    function () {
...
add_filter(
    'wbcr/factory/populate_option_resize_larger',
    function () {
